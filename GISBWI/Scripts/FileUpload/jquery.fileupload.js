    ...
    $.widget('blueimp.fileupload', {
        ...
        _onProgress: function (e, data) {
            if (e.lengthComputable) {
                ...
                this._bitrate = this._bitrateTimer.getBitrate(
                    now,
                    this._loaded,
                    data.bitrateInterval
                );
                //console.log(this._bitrate);
                //console.log('bitrateInterval: ' + data.bitrateInterval);
        ...
        _onAlways: function (jqXHRorResult, textStatus, jqXHRorError, options) {
            ...
            if (this._active === 0) {
                ...
                this._loaded = this._total = this._bitrate = 0;
            }
        },
        ...
        _create: function () {
            ...
            this._sending = this._active = this._loaded = this._total = this._bitrate = 0;
            this._initEventHandlers();
        },
