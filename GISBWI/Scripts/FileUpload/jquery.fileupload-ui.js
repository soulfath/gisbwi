    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        options: {
            ...
            progressall: function (e, data) {
                ...
                var $this = $(this),
                globalProgressNode = $this.find('.fileupload-buttonbar'),
                ...
                //var dut = ((data.loaded / data.total) * 100).toFixed(2);
                //console.log(data.loaded + '/' + data.total)
                //console.log(dut + '%');

                //if (data.bitrate >= 1000000000) {
                //    console.log((data.bitrate / 1000000000).toFixed(2) + ' Gbit/s');
                //}
                //else if (data.bitrate >= 1000000) {
                //    console.log((data.bitrate / 1000000).toFixed(2) + ' Mbit/s');
                //}
                //else if (data.bitrate >= 1000) {
                //    console.log((data.bitrate / 1000).toFixed(2) + ' kbit/s');
                //}
                //else { console.log(data.bitrate.toFixed(2) + ' bit/s'); }
                //console.log('bitrate'+ data.bitrate.toFixed(2));
